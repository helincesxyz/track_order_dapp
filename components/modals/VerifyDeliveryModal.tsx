// components/modals/VerifyDeliveryModal.tsx
...
const VerifyDeliveryModal: React.FC<VerifyDeliveryModalProps> = ({ isOpen, onClose }) => {
    const { verifyDelivery } = useOrderContext();
    const [orderId, setOrderId] = useState(0);

    const handleSubmit = async (e: React.FormEvent) => {
        e.preventDefault();
        await verifyDelivery(orderId);
        onClose();
    }
